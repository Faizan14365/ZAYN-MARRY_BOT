...
async function startXeonBotInc() {
    ...
    if (pairingCode && !XeonBotInc.authState.creds.registered) {
        ...
        if (!pn('+' + phoneNumber).isValid()) {
            console.log(chalk.red('Invalid phone number. Please enter your full international number (e.g., 92323xxxxxxx for US, 9232370xxx for UK, etc.) without + or spaces.'));
            process.exit(1);
        }
